                ...
                <div className="about">
                    ...
                    <div className="about__gallery">
                        <div className="about__gallery__container">
                            <img src="img/three.jpg" alt="Swimming pool" />
                        </div>
                        <div className="about__gallery__container">
                            <img src="img/two.jpg" alt="Playground" />
                        </div>
                        <div className="about__gallery__container">
                            <img src="img/four.jpg" alt="Playground" />
                        </div>
                        <div className="about__gallery__container">
                            <img src="img/one_crop.png" alt="Main building" />
                        </div>
                        <div className="about__gallery__container">
                            <img src="img/five.jpg" alt="Kitchen" />
                        </div>
                        <div className="about__gallery__container">
                            <img src="img/six.jpg" alt="Interior" />
                        </div>
                        <div className="about__gallery__container">
                            <img src="img/seven.jpg" alt="Building exterior" />
                        </div>
